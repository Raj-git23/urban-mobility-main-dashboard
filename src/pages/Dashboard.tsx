...
export default function Dashboard() {
  ...
  const mapplsApiKey = "38dec545-b224-471d-97bd-674a52a3b09c"; // Replace with your API key
...
<div className="text-3xl font-extrabold bg-gradient-to-r from-indigo-800 via-purple-700 to-purple-500 text-transparent bg-clip-text font-serif">
  ...
  {stats.map((stat) => {
    ...
    return (
      <div key={stat.title} className="group relative glass-card p-6 rounded-xl transition-all duration-300">
        ...
        <div className=" text-black absolute inset-0 rounded-xl border-2 border-transparent 
        ...
        {/* Content Inside */}
        <div className="relative bg-white/20 p-6 rounded-xl">
          <div className="flex items-center justify-between">
            <div>
